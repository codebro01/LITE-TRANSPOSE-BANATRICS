...
export const installmentProofTable = pgTable(
  'installment_proofs',
  {
  ...
  (table) => ({
    idx_installmentProofs_userId_campaignId: index(
      'idx_installmentProofs_userId_campaignId'
    ).on(table.userId, table.campaignId),
    idx_installmentProofs_userId_campaignId_statusType: index(
      'idx_installmentProofs_userId_campaignId_statusType'
    ).on(table.userId, table.campaignId, table.statusType),
  }),
);

export type installmentProofInsertType =
  typeof installmentProofTable.$inferInsert;
